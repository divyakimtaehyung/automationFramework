package com.iexceed.uiframework.profile;
...
public class FirefoxBrowserProfile extends BrowserProfile {
     ...
     *
     * @param acceptUntrustedSsl - boolean value specifying whether to accept untrusted
     *                           certificates or not!
     ...
     *
     * @param showDownloadManager - boolean value specifying whether to show download manager!
     * @return - this profile instance
     */
     ...
     *
     * @param downloadDirectory - path to download directory
     * @return - this profile instance
     */
     ...
     *
     * @param filesToSaveDirectly - for which file types, we do not want the browser to ask
     *                            permission.
     * @return - this profile instance
     */
