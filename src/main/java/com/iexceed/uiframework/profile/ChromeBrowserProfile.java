...
public class ChromeBrowserProfile extends BrowserProfile {
     ...
     *
     * @param extensions - List of chrome extensions
     ...
     *
     * @param profilePath - path to chrome profile directory
     * @return - this profile instance
     */
     ...
     *
     * @param binaryExecutablePath - executable chrome binary path
     * @return - this profile instance
     */
     ...
     *
     * @param prefs - A key value pair of prefrences and values
     * @return - this profile instance
     */
