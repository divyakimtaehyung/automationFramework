...
import com.iexceed.uiframework.exception.InvalidLocatorStrategyException;
import com.iexceed.uiframework.exception.PropertyNotFoundException;
import com.iexceed.uiframework.utilites.ObjectRepository;
...
public class BasePage {
     ...
     * @param replacement                  - if element contains dynamic part, i.e. '$value' in locator
     *                                     part, then '$value' part will be replaced by replacement value
     * @param ignoreNoSuchElementException - if set to true, then no exceptions will be thrown when
     *                                     element is not found, Suitable for situations where you want
     *                                     the test to progress despite of the result that click action
     *                                     succeeded or not!
     * @throws PropertyNotFoundException       - throw this exception when declared locator is not found in
     *                                         object repository
     * @throws InvalidLocatorStrategyException - throw this exception when locator strategy is wrong. Valid
     ...
     * @param replacement - if element contains dynamic part, i.e. '$value' in locator
     *                    part, then '$value' part will be replaced by replacement value
     * @param optionText  - dropdown option text
     * @throws PropertyNotFoundException       - throw this exception when declared locator is not found in
     *                                         object repository
     * @throws InvalidLocatorStrategyException - throw this exception when locator strategy is wrong. Valid
     *                                         locator strategies are 'ID', 'XPATH', 'NAME', 'CSS_SELECTOR',
     ...
     * @param replacement - if element contains dynamic part, i.e. '$value' in locator
     *                    part, then '$value' part will be replaced by replacement value
     * @param optionIndex - index of dropdown option
     * @throws PropertyNotFoundException       - throw this exception when declared locator is not found in
     *                                         object repository
     * @throws InvalidLocatorStrategyException - throw this exception when locator strategy is wrong. Valid
     *                                         locator strategies are 'ID', 'XPATH', 'NAME', 'CSS_SELECTOR',
     ...
     * @param replacement - if element contains dynamic part, i.e. '$value' in locator
     *                    part, then '$value' part will be replaced by replacement value
     * @param attr        - element atrribute whose value is to needed
     ...
     *
     * @param timeInSeconds - sleep time in seconds
     */
     ...
     * @param replacement       - if element contains dynamic part, i.e. '$value' in locator
     *                          part, then '$value' part will be replaced by replacement value
     * @param waitTimeInSeconds - timeout period
     * @throws PropertyNotFoundException       - throw this exception when declared locator is not found in
     *                                         object repository
     * @throws InvalidLocatorStrategyException - throw this exception when locator strategy is wrong. Valid
     *                                         locator strategies are 'ID', 'XPATH', 'NAME', 'CSS_SELECTOR',
     ...
     *
     * @param windowName - name/id of window
     */
